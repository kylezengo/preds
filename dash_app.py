...
def update_graph(short_window, long_window, oversold, overbought, rsi_window):
    ...
    # Daily SPY with moving averages and RSI
    ...
    fig_sub.add_trace(go.Scatter(x=df_for_chart['Date'], y=df_for_chart['Adj Close'],mode='lines', name='SPY Adj Close'), row=1, col=1)
    ...
    fig_sub.update_layout(title="Daily SPY Adj Close", legend=dict(yanchor="top",y=0.98, xanchor="left", x=0.01))
